...
## ⚠️ 사주 계산 주의
명식·세운 계산은 [`lunar-javascript`](https://github.com/6tail/lunar-javascript) 만세력을 사용합니다(입춘·각월 절입 시각, 23시 자시 경계 반영).
다만 한국 경도 보정(약 -32분)과 균시차는 적용되지 않아 시주 경계 부근(±30분)에서는 오차가 있을 수 있습니다.
