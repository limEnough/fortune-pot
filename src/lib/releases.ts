...
export const RELEASES: ReleaseNote[] = [
  {
    ...
    title: "내 곁의 사람들, 귀인지도",
    items: [
      { tag: "new", text: "생년월일만 넣으면 내 귀인지도가 그려져요. 가운데가 나, 둘레의 별이 나와 인연이 닿은 사람들이에요." },
      { tag: "new", text: "링크를 보내면 친구가 자기 생일을 넣고 지도에 별로 올라와요. 친구도 '나는 OO님에게 어떤 사람일까?' 결과를 바로 받아요." },
      { tag: "new", text: "귀인·단짝·내 사람·오른팔·호랑이 선생 다섯 유형과 케미 점수로 나래비를 세워요. 이름을 누르면 조심할 점도 볼 수 있어요." },
      { tag: "new", text: "지도에는 이름과 유형만 보여요. 생년월일은 궁합을 볼 때만 쓰이고 다른 사람에게 보이지 않아요." },
      { tag: "new", text: "잘못 넣었어도 괜찮아요. 같은 링크에서 다시 올리면 줄이 늘지 않고 최신 내용으로 바뀌어요." },
      { tag: "new", text: "이름을 올리면 상대방의 귀인지도도 구경할 수 있어요. 내가 그 사람들 사이 어디쯤인지 바로 보여요." },
      { tag: "improve", text: "최근에 본 사주가 있으면 첫 화면에서 물어보고, 운세·사주·귀인지도를 다시 입력 없이 그 정보로 볼 수 있어요. 초기화 버튼도 첫 화면에 있어요." },
    ],
  },
  {
    version: "0.7.0",
